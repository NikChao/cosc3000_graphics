...
"""
        ...
        fragmentShader = """
            ...
            void main() 
            {
                ...
                vec4 colour = ambient * sphereColour;
	            fragmentColor = vec4(colour.xyz * shading, sphereColour.w);
            }
        """
        g_sphereShader = buildShader([vertexShader], [fragmentShader], {"positionIn" : 0, "normalIn" : 1})
        # glUniform3fv(glGetUniformLocation(g_sphereShader, "lightPos"), 1, lightPosition)


    glUseProgram(g_sphereShader)
    setUniform(g_sphereShader, "sphereColour", sphereColour)
    glUniform4fv(glGetUniformLocation(g_sphereShader, "colour"), 1, sphereColour);
    glUniform4fv(glGetUniformLocation(g_sphereShader, "lightColour"), 1, (1.0, 1.0, 1.0, 1.0));

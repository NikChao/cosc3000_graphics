...
g_simpleShader = 0
clay_texture = Image.open("./clay.jpg")
...
def drawVertexDataAsTrianglesColour(triangleVerts, transform, colour, lightPosition=[1,1,1]):
    global clay_texture;
    
    def setColour(shader):
        glUniform4fv(glGetUniformLocation(shader, "colour"), 1, colour);
        glUniform4fv(glGetUniformLocation(shader, "lightColour"), 1, (1.0, 1.0, 1.0, 1.0));
        glUniform3fv(glGetUniformLocation(shader, "lightPos"), 1, lightPosition)
